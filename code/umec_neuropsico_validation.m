...
vars = struct( ...
    'megtusalen', ...
    {'age','sex','group','conversion_time', 'evolution_time', 'family_history', 'edu_years','edu_level_umec','occupation_umec', ...
    ...
    'umec', ...
    {'Edad','sexo','Diagnostico','T_Conversion', 'T_Evolucion', 'antec_familia_demenc','numanosescol','Estudios', 'rc_ocupac_labor', ...
